...
class TestCarteraQA(unittest.TestCase):
    ...
    def test_historial_auditoria(self):
        """Verificar que el historial de cambios registra movimientos."""
    ...
    def test_comparacion_exacta_caso(self):
        """Validar los datos específicos del CASO.txt."""
        total_2023 = 53130
